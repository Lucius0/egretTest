var GestureRecognizerPlugin = (function () {
    ...
    var __egretProto__ = GestureRecognizerPlugin.prototype;
    /**
    ...
    __egretProto__._onInitGesture = function (callback, config, g) {
    ...
    /** @private **/
    __egretProto__.executeGestureRecognizedCallback = function () {
    ...
    /** @private **/
    __egretProto__.checkGesture = function (ts) {
        return false;
    };
    /** @private **/
    __egretProto__.updateValue = function (ts) {
        //return true means this continuous gesture has began to effect, while return false means the gestures has stopped.
        return true;
    };
    /** @private **/
    __egretProto__.gesturePossible = function (value) {
