...
module gesture
{
    ...
    /**手势的抽象类*/
    export class AbstractGesture extends egret.EventDispatcher implements gesture.IGesture
    {
        /**手势监听的显示对象*/
        ...
        public gestureBegan():void {
            this._stats = 1;
            var evt:gesture.GestureEvent = new gesture.GestureEvent(gesture.GestureEvent.BEGAN);
        ...
        public gestureEnded():void {
            this._stats = 3;
            var evt:gesture.GestureEvent = new gesture.GestureEvent(gesture.GestureEvent.ENDED);
            evt.host = this._target;
            this.dispatchEvent(evt);
            this._stats = -1;
        }
        ...
        public gestureFailed():void {
            var evt:gesture.GestureEvent = new gesture.GestureEvent(gesture.GestureEvent.FAILED);
            evt.host = this._target;
            this.dispatchEvent(evt);
            this._stats = -1;
        }
