...
(function (utils) {
    var Drag = (function (_super) {
        ...
        __egretProto__.onTouchMove = function (e) {
            var tempX = e.stageX - ((this.dragObject.width * this.dragObject.scaleX) / 2) - (this.dragObject.anchorX * (this.dragObject.width * this.dragObject.scaleX)) + this.offsetX;
            var tempY = e.stageY - ((this.dragObject.height * this.dragObject.scaleY) / 2) + (this.dragObject.anchorY * (this.dragObject.height * this.dragObject.scaleY)) + this.offsetY;
            if (this.dragObject) {
