...
(function (skins) {
    var TabBarSkin = (function (_super) {
        ...
        TabBarSkin.prototype.dataGroup_i = function () {
            ...
            this.dataGroup = t;
            this.__s(t, ["bottom", "percentHeight", "itemRenderer", "itemRendererSkinName", "top", "percentWidth"], [0, 100, new egret.gui.ClassFactory(egret.gui.TabBarButton), skins.TabBarButtonSkin, 90, 100]);
            t.layout = this.__3_i();
            return t;
        };
    ...
    TabBarSkin.prototype.__class__ = "skins.TabBarSkin";
})(skins || (skins = {}));
